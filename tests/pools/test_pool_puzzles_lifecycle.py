...
from cryptodogelight.wallet.puzzles.p2_conditions import puzzle_for_conditions
from cryptodogelight.wallet.puzzles import singleton_top_layer
from cryptodogelight.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - cryptodogelight.pools.pool_puzzles.py
    - cryptodogelight.wallet.puzzles.pool_member_innerpuz.clvm
    - cryptodogelight.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
