...
from cryptodogelight.pools.pool_config import PoolWalletConfig
from cryptodogelight.util.config import load_config, save_config, create_default_cryptodogelight_config
...
def test_pool_config():
    ...
    create_default_cryptodogelight_config(test_root, ["config.yaml"])
