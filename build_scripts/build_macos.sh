...
#   electron-osx-sign Cryptodoge\ Light\ Wallet-darwin-x64/Cryptodoge\ Light\ Wallet.app --platform=darwin \
...
mv Cryptodoge\ Light\ Wallet-darwin-x64 ../../../build_scripts/dist/
cd ../../../build_scripts || exit

DMG_NAME="CryptodogeLight-$CRYPTODOGE_INSTALLER_VERSION.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Cryptodoge\ Light\ Wallet-darwin-x64/Cryptodoge\ Light\ Wallet.app Cryptodoge-$CRYPTODOGE_INSTALLER_VERSION \
