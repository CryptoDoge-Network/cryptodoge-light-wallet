...
import icon from '../../assets/img/cryptodogelight_logo.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Chia Network, Cryptodoge Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
