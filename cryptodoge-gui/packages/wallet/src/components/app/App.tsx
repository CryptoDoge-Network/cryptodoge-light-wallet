...
import { Loading, ThemeProvider, ModalDialogsProvider, ModalDialogs } from '@cryptodogelight/core';
import { store, api } from '@cryptodogelight/api-react';
import { Wallet, ServiceName } from '@cryptodogelight/api';
