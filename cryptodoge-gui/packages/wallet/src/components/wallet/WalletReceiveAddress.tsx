...
import { CopyToClipboard, Card, Loading } from '@cryptodogelight/core';
import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@cryptodogelight/api-react';
import {
  Box,
  Button,
  TextField,
