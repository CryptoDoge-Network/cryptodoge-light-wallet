...
import { Card, CardKeyValue, CopyToClipboard, Flex, Loading, TableControlled } from '@cryptodogelight/core';
import styled from 'styled-components';
import type { Row } from '../core/components/Table/Table';
import {
  mojo_to_cryptodogelight_string,
...
const getCols = (type: WalletType) => [
      ...
      return (
        <>
          ...
          <strong>
            ...
            : mojo_to_cryptodogelight_string(row.amount)}
          </strong>
          &nbsp;
          {metadata.unit}
        </>
  ...
  },
  {
    field: (row: Row, metadata) => (
      <>
        <strong>{mojo_to_cryptodogelight_string(row.feeAmount)}</strong>
        &nbsp;
        {metadata.feeUnit}
      </>
    ),
