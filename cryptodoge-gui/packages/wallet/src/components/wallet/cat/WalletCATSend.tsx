...
} from '@cryptodogelight/api-react';
import isNumeric from 'validator/es/lib/isNumeric';
import { useForm, useWatch } from 'react-hook-form';
import { Button, Grid } from '@material-ui/core';
import { cryptodogelight_to_mojo, colouredcoin_to_mojo } from '../../../util/cryptodogelight';
...
export default function WalletCATSend(props: Props) {
  ...
  async function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      throw new Error(t`Cannot send cryptodogelight to coloured address. Please enter a cryptodogelight address.`);
    }
