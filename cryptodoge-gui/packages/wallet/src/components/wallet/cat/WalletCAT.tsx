...
import { Card, CopyToClipboard, Flex, Loading, useOpenDialog } from '@cryptodogelight/core';
...
import { useSetCATNameMutation, useGetCatListQuery } from '@cryptodogelight/api-react';
