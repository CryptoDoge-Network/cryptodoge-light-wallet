...
import { AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@cryptodogelight/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = cryptodogelight_to_mojo(amount || '0');
  ...
  return (
    <Form methods={methods} onSubmit={handleSubmit}>
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          <Trans>Create New Cryptodoge Asset Token Wallet</Trans>
        </Back>
        <Card>
