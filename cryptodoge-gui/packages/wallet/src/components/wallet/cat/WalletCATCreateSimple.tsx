...
import { Back, Flex, Loading, useShowError } from '@cryptodogelight/core';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@cryptodogelight/api-react';
