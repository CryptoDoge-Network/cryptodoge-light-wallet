...
import { Button, ConfirmDialog, Flex, Logo, Loading, useOpenDialog, TooltipIcon } from '@cryptodogelight/core';
import {
  Card,
  Typography,
  Container,
          ...
          {isLoading ? (
            ...
            <>
              ...
              <Typography variant="subtitle1">
                <Trans>
                  Welcome to Cryptodoge. Please log in with an existing key, or create
                  a new key.
                </Trans>
              </Typography>
            </>
