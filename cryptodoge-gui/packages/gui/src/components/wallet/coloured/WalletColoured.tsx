...
function BalanceCard(props: BalanceCardProps) {
  ...
  const balance_ptotal_cryptodogelight = mojo_to_colouredcoin_string(balance_ptotal);
  const balance_pending_cryptodogelight = mojo_to_colouredcoin_string(balance_pending);
  const balance_change_cryptodogelight = mojo_to_colouredcoin_string(balance_change);
  const acc_content =
    balancebox_1 +
    balancebox_2 +
    balancebox_ptotal +
    balancebox_3 +
    balance_ptotal_cryptodogelight +
    balancebox_unit +
    balancebox_hline +
    balancebox_4 +
    balancebox_row +
    ...
    balancebox_pending +
    balancebox_3 +
    balance_pending_cryptodogelight +
    balancebox_unit +
    balancebox_4 +
    balancebox_row +
    balancebox_2 +
    balancebox_change +
    balancebox_3 +
    balance_change_cryptodogelight +
    balancebox_unit +
    balancebox_5;
...
function SendCard(props: SendCardProps) {
  ...
  function send() {
    ...
    if (address.includes('cryptodogelight_addr') || address.includes('colour_desc')) {
      dispatch(
        openDialog(
          <AlertDialog>
