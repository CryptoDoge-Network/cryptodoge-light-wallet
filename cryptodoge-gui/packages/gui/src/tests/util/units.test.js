...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of cryptodogelight', () => {
      const result = units.getUnit('cryptodogelight');
    ...
    it('gets unit of cryptodogelight using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of cryptodogelight', () => {
      const result = units.getDisplay('cryptodogelight');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('cryptodogelight', 9);

      const result = units.getUnit('cryptodogelight');

      expect(result).toEqual(9);

      units.setUnit('cryptodogelight', 1);
    });
  });
  describe('#setDisplay', () => {
    ...
    it('updates an existing display', () => {
      units.setDisplay('cryptodogelight', {
        format: '{amount} TXCD',
        fractionDigits: 0,
      });
