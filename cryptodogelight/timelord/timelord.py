...
from cryptodogelight.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from cryptodogelight.timelord.iters_from_block import iters_from_block
from cryptodogelight.timelord.timelord_state import LastState
from cryptodogelight.timelord.types import Chain, IterationType, StateType
from cryptodogelight.types.blockchain_format.classgroup import ClassgroupElement
from cryptodogelight.types.blockchain_format.reward_chain_block import RewardChainBlock
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[CryptodogeServer] = None
