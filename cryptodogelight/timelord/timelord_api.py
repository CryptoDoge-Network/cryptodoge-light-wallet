...
from cryptodogelight.timelord.timelord import Chain, IterationType, Timelord, iters_from_block
from cryptodogelight.util.api_decorators import api_request
