...
from cryptodogelight.harvester.harvester import Harvester
from cryptodogelight.plotting.util import PlotInfo, parse_plot_info
from cryptodogelight.protocols import harvester_protocol
from cryptodogelight.protocols.farmer_protocol import FarmingInfo
from cryptodogelight.protocols.harvester_protocol import Plot
...
from cryptodogelight.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSCryptodogeConnection
    ):
        """
