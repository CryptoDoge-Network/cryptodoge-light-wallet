...
from cryptodogelight.consensus.network_type import NetworkType
from cryptodogelight.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from cryptodogelight.farmer.farmer import Farmer
from cryptodogelight.protocols import farmer_protocol, harvester_protocol
from cryptodogelight.protocols.harvester_protocol import PoolDifficulty
...
from cryptodogelight.util.api_decorators import api_request, peer_required
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSCryptodogeConnection
    ):
        """
    ...
    @api_request
    @peer_required
    async def respond_plots(self, _: harvester_protocol.RespondPlots, peer: ws.WSCryptodogeConnection):
