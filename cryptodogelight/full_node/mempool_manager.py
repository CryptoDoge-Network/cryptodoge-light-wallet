...
from cryptodogelight.consensus.cost_calculator import NPCResult, calculate_cost_of_program
...
from cryptodogelight.full_node.mempool_check_conditions import mempool_check_conditions_dict, get_name_puzzle_conditions
...
from cryptodogelight.util.cached_bls import LOCAL_CACHE
from cryptodogelight.util.clvm import int_from_bytes
from cryptodogelight.util.condition_tools import pkm_pairs
from cryptodogelight.util.errors import Err, ValidationError
from cryptodogelight.util.generator_tools import additions_for_npc
...
class MempoolManager:
    def __init__(self, coin_store: CoinStore, consensus_constants: ConsensusConstants):
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 XCD per block, or about 0.00005 XCD for two
        # spends.
    ...
    async def add_spendbundle(
        ...
        for npc in npc_list:
            ...
            error = mempool_check_conditions_dict(
                coin_record,
                npc.condition_dict,
                uint32(cryptodogelightlisp_height),
                self.peak.timestamp,
            )
