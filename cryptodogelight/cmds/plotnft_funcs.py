...
from cryptodogelight.cmds.wallet_funcs import print_balance, wallet_coin_unit
        ...
        try:
            ...
            while time.time() - start < 10:
                ...
                if len(tx.sent_to) > 0:
                    ...
                    print(f"Do cryptodogelight wallet get_transaction -f {fingerprint} -tx 0x{tx_record.name} to get status")
                    return None
        except Exception as e:
    ...
    try:
        ...
        if isinstance(e, aiohttp.ClientConnectorError):
            print(
                ...
                f" You can run the farmer by:\n    cryptodogelight start farmer-only"
            )
        else:
