...
from cryptodogelight.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "56888"
            testnet_introducer = "introducer-testnet10.cryptodoge.cc"
            testnet_dns_introducer = "dns-introducer-testnet10.cryptodoge.cc"
            testnet = "testnet10"
    ...
    if change_made:
        print("Restart any running cryptodogelight services for changes to take effect")
